...
The preferred compiled replacement UI uses **Rust/Dioxus Desktop**, with Python
...
macOS. Windows delivery will use the preferred Dioxus UI. The current application
