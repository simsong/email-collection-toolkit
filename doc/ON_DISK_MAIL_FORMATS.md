...
| [`outlook-pst-rs`](https://github.com/microsoft/outlook-pst-rs) | Rust; MIT | Yes, read-only API | Not qualified here | Implemented standalone adapter, locally validated with 12 messages and 30 attachments. Broader corpus/platform qualification remains pending. |
